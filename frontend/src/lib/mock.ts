...
export const MOCK_SOURCES: Source[] = [
  // Repos
  {
    ...
    status: 'ready',
    stats: { entities: 2847, cards: 156, domains: 34 },
    format: 'git',
  ...
  },
  {
    ...
    status: 'ready',
    stats: { entities: 45012, cards: 892, domains: 421 },
    format: 'git',
  ...
  },
  {
    ...
    status: 'ready',
    stats: { entities: 3421, cards: 234, domains: 58 },
    format: 'git',
  ...
  // Documents
  {
    ...
    status: 'ready',
    stats: { entities: 28, cards: 12, domains: 0 },
    format: 'pdf',
  ...
  },
  {
    ...
    status: 'ready',
    stats: { entities: 87, cards: 18, domains: 0 },
    format: 'xlsx',
  ...
  },
  {
    ...
    status: 'ready',
    stats: { entities: 12, cards: 8, domains: 0 },
    format: 'md',
  ...
  },
  {
    ...
    status: 'indexing',
    progress: 67,
    stats: { entities: 45, cards: 22, domains: 0 },
    format: 'pdf',
